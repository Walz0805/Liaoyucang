...
export const narrationFiles={consent:'consent',scan:'liangbiao',prepare:'prepare',select:'select','select-goal':'select',after:'after',report:'report',C01:'guide',F01:'wake'};
